...
@Component({
  selector: 'app-component-service-history',
  templateUrl: './component-service-history.component.html',
  styleUrls: ['./component-service-history.component.scss'],
})
export class ComponenterviceHistoryComponent implements OnInit {
  serviceNote: any;
  filterText: string;
  ...
  serviceHistoryList(vehicleNum) {
    ...
    this.tempData = [];
    this.dataServiceDetail = [];
    this.tempDataServiceDetail = [];this.serviceNote='';
