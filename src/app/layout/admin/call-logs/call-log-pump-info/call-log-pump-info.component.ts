...
@Component({
  selector: 'app-call-log-pump-info',
  templateUrl: './call-log-pump-info.component.html',
  styleUrls: ['./call-log-pump-info.component.scss'],
})
export class CallLogPumpInfoComponent implements OnInit {
