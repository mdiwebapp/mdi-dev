...
export const ViewData = [
  {
    id: 1,
    ee: 'CSMCR',
    branch: '12" SLOTTED STEEL SCREEN BY LINEAL FOOT',
  },
];
...
export const ReceivingInventoriesData = [
  {
    poNumber: 'B72758',
    branch: 'MI',
    itemCode: 'PUSUVE500R',
    description: '500HP Vertical Turbine Pump',
    uom: 'EA',
    orderQty: 1,
    receiveQty: 0,
    receive: '',
